...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _configureStore2.default)(initalState);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var posActions = _interopRequireWildcard(_actions);

	var _Receipt = __webpack_require__(193);

	var _Receipt2 = _interopRequireDefault(_Receipt);

	var _Shop = __webpack_require__(198);
	...
	App.PropTypes = {
	    ...
	    receipt: _react.PropTypes.object.isRequired
	};
	...
	function mapDispatchToProps(dispatch) {
	    return {
	        actions: (0, _redux.bindActionCreators)(posActions, dispatch)
	    };
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function addItemToCart(item) {
	    return { type: types.ADD_ITEM_TO_CART, item: item };
	}

	function removeItemFromCart(barcode) {
	    return { type: types.REMOVE_ITEM_FROM_CART, barcode: barcode };
	}

	function changeItemCount(barcode, count) {
	    return { type: types.CHANGE_ITEM_COUNT, barcode: barcode, count: count };
	}

	function calculateAmount(cartItems) {
	    return { type: types.CALCULATE_AMOUNT, cartItems: cartItems };
	}
...
/***/ function(module, exports) {
	...
	var CHANGE_ITEM_COUNT = exports.CHANGE_ITEM_COUNT = 'CHANGE_ITEM_COUNT';
	var CALCULATE_AMOUNT = exports.CALCULATE_AMOUNT = 'CALCULATE_AMOUNT';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ItemsInfo = __webpack_require__(194);

	var _ItemsInfo2 = _interopRequireDefault(_ItemsInfo);

	var _FreeItemsInfo = __webpack_require__(195);

	var _FreeItemsInfo2 = _interopRequireDefault(_FreeItemsInfo);

	var _ReceiptHeader = __webpack_require__(196);

	var _ReceiptHeader2 = _interopRequireDefault(_ReceiptHeader);

	var _ReceiptFooter = __webpack_require__(197);

	var _ReceiptFooter2 = _interopRequireDefault(_ReceiptFooter);
	...
	var Receipt = function (_Component) {
	    ...
	    function Receipt() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Receipt).apply(this, arguments));
	    }
	    ...
	    _createClass(Receipt, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'receipt inline-block' },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'title' },
	                    'Receipt'
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(_ReceiptHeader2.default, { shopName: receipt.shopName }),
	                    _react2.default.createElement(_ItemsInfo2.default, { itemsInfo: receipt.itemsInfo }),
	                    _react2.default.createElement(_FreeItemsInfo2.default, { freeItemsInfo: receipt.freeItemsInfo }),
	                    _react2.default.createElement(_ReceiptFooter2.default, { costInfo: receipt.costInfo })
	                )
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemsInfo = function (_Component) {
	    _inherits(ItemsInfo, _Component);

	    function ItemsInfo() {
	        _classCallCheck(this, ItemsInfo);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ItemsInfo).apply(this, arguments));
	    }
	...
	exports.default = ItemsInfo;


	ItemsInfo.PropTypes = {
	    itemsInfo: _react.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FreeItemsInfo = function (_Component) {
	    _inherits(FreeItemsInfo, _Component);

	    function FreeItemsInfo() {
	        _classCallCheck(this, FreeItemsInfo);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FreeItemsInfo).apply(this, arguments));
	    }
	    ...
	    return FreeItemsInfo;
	}(_react.Component);

	exports.default = FreeItemsInfo;


	FreeItemsInfo.PropTypes = {
	    freeItemsInfo: _react.PropTypes.array.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReceiptHeader = function (_Component) {
	    _inherits(ReceiptHeader, _Component);

	    function ReceiptHeader() {
	        _classCallCheck(this, ReceiptHeader);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ReceiptHeader).apply(this, arguments));
	    }

	    _createClass(ReceiptHeader, [{
	        key: 'renderCalculateTime',
	        value: function renderCalculateTime() {
	            var dateDigitToString = function dateDigitToString(num) {
	...
	exports.default = ReceiptHeader;


	ReceiptHeader.PropTypes = {
	    shopName: _react.PropTypes.string.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReceiptFooter = function (_Component) {
	    _inherits(ReceiptFooter, _Component);

	    function ReceiptFooter() {
	        _classCallCheck(this, ReceiptFooter);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(ReceiptFooter).apply(this, arguments));
	    }

	    _createClass(ReceiptFooter, [{
	        key: "render",
	        value: function render() {
	            var costInfo = this.props.costInfo;
	            return _react2.default.createElement(
	                "div",
	...
	exports.default = ReceiptFooter;


	ReceiptFooter.PropTypes = {
	    costInfo: _react.PropTypes.object.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(Shop, [{
	        ...
	        value: function renderItem() {
	            ...
	            return this.props.items.map(function (item, index) {
	                return _react2.default.createElement(_Item2.default, { item: item, addItemToCart: function addItemToCart(e) {
	                        return _this2.props.addItemToCart(item);
	                    }, key: index });
	            });
	        }
	    }, {
	...
	Shop.PropTypes = {
	    items: _react.PropTypes.array.isRequired,
	    addItemToCart: _react.PropTypes.func.isRequired
	};
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement("img", { src: this.props.item.logo })
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "name inline-block" },
	                    this.props.item.name
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "price inline-block" },
	                    _react2.default.createElement(
	                        "strong",
	                        { className: "money" },
	                        "$",
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "deal inline-block" },
	                    _react2.default.createElement(
	                        "a",
	                        { className: "btn", onClick: this.props.addItemToCart },
	                        "添加到购物车"
	                    )
	                )
	            );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CartItem = __webpack_require__(201);
	...
	Cart.PropTypes = {
	    changeCount: _react.PropTypes.func.isRequired,
	    cartItems: _react.PropTypes.array.isRequired,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CartItem = function (_Component) {
	    ...
	    _createClass(CartItem, [{
	        ...
	        value: function onchange(e) {
	            var node = this.refs.barcode;
	            var barcode = node.value.trim();
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "logo inline-block" },
	                    _react2.default.createElement("img", { src: this.props.cartItem.logo })
	                ),
	                _react2.default.createElement(
	                    "div",
	                    { className: "name inline-block" },
	                ...
	                _react2.default.createElement(
	                    "div",
	                    { className: "count inline-block" },
	                    _react2.default.createElement("input", { type: "hidden", value: this.props.cartItem.barcode, ref: "barcode" }),
	                    _react2.default.createElement("input", { type: "number", value: this.props.cartItem.count, min: "0", onChange: function onChange(e) {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        "a",
	                        { className: "btn", onClick: this.props.remove },
	                        "删除"
	                    )
	                )
	            );
	...
	CartItem.PropTypes = {
	    changeCount: _react.PropTypes.func.isRequired,
	    cartItem: _react.PropTypes.object.isRequired,
	    remove: _react.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cartItems = __webpack_require__(204);
	...
	var _receipt = __webpack_require__(206);

	var _receipt2 = _interopRequireDefault(_receipt);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({ items: _items2.default, cartItems: _cartItems2.default, receipt: _receipt2.default });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cartItems() {
	    ...
	    switch (action.type) {
	        case _ActionTypes.ADD_ITEM_TO_CART:
	            var status = state.find(function (cartItem) {
	                return cartItem.barcode === action.item.barcode;
	            });
	            if (status) {
	        ...
	        case _ActionTypes.REMOVE_ITEM_FROM_CART:
	            return state.filter(function (cartItem) {
	                return cartItem.barcode !== action.barcode;
	            });
	        case _ActionTypes.CHANGE_ITEM_COUNT:
	            var newState = state.map(function (cartItem) {
	                return cartItem.barcode === action.barcode ? Object.assign({}, cartItem, { count: action.count }) : cartItem;
	            });
	            return newState;
	        default:
	            return state;
...
/***/ function(module, exports, __webpack_require__) {
	...
	function receipt() {
	    ...
	    switch (action.type) {
	        case _ActionTypes.CALCULATE_AMOUNT:
